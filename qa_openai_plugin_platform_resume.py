...
def inspect_docx(path: Path) -> dict:
    ...
    result.update(
        {
            ...
            "revision_session_ids_present": "w:rsid" in all_story_xml,
    ...
    result["passed"] = all(
        [
            ...
            "Plugin Developer Platform" in result["title"],
            "Plugin Developer Platform" in result["subject"],
            ...
            not result["revision_session_ids_present"],
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Structural QA for the OpenAI Plugin Developer Platform resume."
    )
