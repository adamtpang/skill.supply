...
def inspect_docx(path: Path) -> dict:
    ...
    result["passed"] = all(
        [
            ...
            # Portfolio is used in both the contact row and the first project.
            # Word correctly reuses that external relationship, so seven
            # clickable links produce six distinct relationship entries.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Structural QA for Adam's Gumloop resume.")
