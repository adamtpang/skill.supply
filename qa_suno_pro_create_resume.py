...
def inspect_docx(path: Path) -> dict:
    ...
    result["passed"] = all(
        [
            ...
            result["hyperlink_relationships"] >= 5,
            result["real_bullet_numbering"],
            result["numbered_paragraphs"] == 5,
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Structural QA for Adam's Suno Pro-Create resume.")
