...
def build(output_path: Path) -> None:
    ...
    properties.title = "Adam Pangelinan - Frontend Software Engineer"
    properties.subject = "Role-specific resume for Beacon AI"
    properties.keywords = "React, TypeScript, frontend, live data, reliable UI, testing"
    properties.author = ""
    ...
    add_labeled_paragraph(
        doc,
        "Frontend: ",
        "TypeScript, JavaScript, React, Next.js, HTML, CSS, responsive UI, state management",
        after=0.6,
    )
    add_labeled_paragraph(
        doc,
        "Data and integration: ",
        "REST APIs, streamed state, structured outputs, Zod validation, live data, Python",
        after=0.6,
    )
    add_labeled_paragraph(
        doc,
        "Quality and delivery: ",
        "accessibility, documentation, code review, Playwright, Vitest, pytest, human approval",
        after=0.8,
    )
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build Adam's Beacon AI role-specific resume.")
