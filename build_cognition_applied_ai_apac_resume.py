...
def build(output_path: Path) -> None:
    ...
    properties.subject = "Role-specific resume for Cognition Applied AI, APAC"
    properties.keywords = "agent deployment, customer engineering, evaluation, TypeScript, Python"
    properties.author = ""
    ...
    add_labeled_paragraph(
        doc,
        "Applied AI: ",
        "agent workflows, MCP, structured outputs, evaluations, human review, browser automation, CDP",
        after=0.6,
    )
    add_labeled_paragraph(
        doc,
    ...
    add_labeled_paragraph(
        ...
        "technical discovery, client delivery, product demos, documentation, Playwright, Vitest, pytest",
        after=0.8,
    )
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build Adam's Cognition Applied AI APAC resume.")
